...
import gg.rimumu.service.ApiTaskService;
...
public class SummonerController extends BaseController {
    ...
    public RimumuResult matches (@RequestParam(required = false) String smnPuuid,
        ...
        try {
            ...
            List<Match> matches = (List<Match>) apiTaskService.ApiParallelCalls(ApiTaskService.ReturnType.MATCH, summoner, matcheIds);
